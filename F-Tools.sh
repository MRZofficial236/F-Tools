...
tools(){
    ...
    mygit="https://github.com/MRZofficial236/"
...
password(){
    ...
    echo -e $green"{";
    echo -e $yellow" Coder : MRZ ID,";
    echo -e $yellow" Yt : MRZ ID,";
    echo -e $yellow" name : Mr. Z,";
    echo -e $green"}\n";
    ...
    if [ $user == "MRZ" ]; then
        if [ $ps == "ID" ]; then
            ...
            echo -e $green"[*] Username atau password benar";
        fi
    else
